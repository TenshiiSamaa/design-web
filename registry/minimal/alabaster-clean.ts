...
export const alabaster_clean: Palette = {
  id: "alabaster-clean",
  slug: "alabaster-clean",
  name: "Alabaster Clean",
  category: "minimal",
  description: "Premium Alabaster Clean palette for modern interface layouts.",
  ...
  light: {
    ...
    scrollbar: "#e5e7eb",
    codeBlock: "#f3f4f6",
    chartColors: ["#1c1917","#3b82f6","#10b981"],
    tableColors: {
      headerBg: "#f3f4f6",
      rowBg: "#ffffff",
  ...
  dark: {
    ...
    scrollbar: "#1f2937",
    codeBlock: "#111827",
    chartColors: ["#1c1917","#60a5fa","#34d399"],
    tableColors: {
      headerBg: "#1f2937",
      rowBg: "#12100e",
