...
export const zinc_neutral: Palette = {
  id: "zinc-neutral",
  slug: "zinc-neutral",
  name: "Zinc Neutral",
  category: "minimal",
  description: "Premium Zinc Neutral palette for modern interface layouts.",
  ...
  light: {
    ...
    scrollbar: "#e5e7eb",
    codeBlock: "#f3f4f6",
    chartColors: ["#3f3f46","#3b82f6","#10b981"],
    tableColors: {
      headerBg: "#f3f4f6",
      rowBg: "#ffffff",
  ...
  dark: {
    ...
    scrollbar: "#1f2937",
    codeBlock: "#111827",
    chartColors: ["#3f3f46","#60a5fa","#34d399"],
    tableColors: {
      headerBg: "#1f2937",
      rowBg: "#09090b",
