...
export const iceberg_arctic: Palette = {
  id: "iceberg-arctic",
  slug: "iceberg-arctic",
  name: "Iceberg Arctic",
  category: "blue",
  description: "Premium Iceberg Arctic palette for modern interface layouts.",
  ...
  light: {
    ...
    scrollbar: "#e5e7eb",
    codeBlock: "#f3f4f6",
    chartColors: ["#06b6d4","#3b82f6","#10b981"],
    tableColors: {
      headerBg: "#f3f4f6",
      rowBg: "#ffffff",
  ...
  dark: {
    ...
    scrollbar: "#1f2937",
    codeBlock: "#111827",
    chartColors: ["#06b6d4","#60a5fa","#34d399"],
    tableColors: {
      headerBg: "#1f2937",
      rowBg: "#083344",
