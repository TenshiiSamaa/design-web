...
export const amethyst_glow: Palette = {
  id: "amethyst-glow",
  slug: "amethyst-glow",
  name: "Amethyst Glow",
  category: "purple",
  description: "Premium Amethyst Glow palette for modern interface layouts.",
  ...
  light: {
    ...
    scrollbar: "#e5e7eb",
    codeBlock: "#f3f4f6",
    chartColors: ["#c084fc","#3b82f6","#10b981"],
    tableColors: {
      headerBg: "#f3f4f6",
      rowBg: "#ffffff",
  ...
  dark: {
    ...
    scrollbar: "#1f2937",
    codeBlock: "#111827",
    chartColors: ["#c084fc","#60a5fa","#34d399"],
    tableColors: {
      headerBg: "#1f2937",
      rowBg: "#2e1065",
