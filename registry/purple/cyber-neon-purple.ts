...
export const cyber_neon_purple: Palette = {
  id: "cyber-neon-purple",
  slug: "cyber-neon-purple",
  name: "Cyber Neon Violet",
  category: "purple",
  description: "Premium Cyber Neon Violet palette for modern interface layouts.",
  ...
  light: {
    ...
    scrollbar: "#e5e7eb",
    codeBlock: "#f3f4f6",
    chartColors: ["#d8b4fe","#3b82f6","#10b981"],
    tableColors: {
      headerBg: "#f3f4f6",
      rowBg: "#ffffff",
  ...
  dark: {
    ...
    scrollbar: "#1f2937",
    codeBlock: "#111827",
    chartColors: ["#d8b4fe","#60a5fa","#34d399"],
    tableColors: {
      headerBg: "#1f2937",
      rowBg: "#0c0214",
