...
export const cyberpunk_2077: Palette = {
  id: "cyberpunk-2077",
  slug: "cyberpunk-2077",
  name: "Cyberpunk 2077",
  category: "creative",
  description: "Premium Cyberpunk 2077 palette for modern interface layouts.",
  ...
  light: {
    ...
    secondary: "#f3f4f6",
    secondaryForeground: "#eab308",
    accent: "rgba(0, 0, 0, 0.05)",
    accentForeground: "#eab308",
    muted: "#f3f4f6",
    ...
    scrollbar: "#e5e7eb",
    codeBlock: "#f3f4f6",
    chartColors: ["#eab308","#3b82f6","#10b981"],
    tableColors: {
      headerBg: "#f3f4f6",
      rowBg: "#ffffff",
  ...
  dark: {
    ...
    scrollbar: "#1f2937",
    codeBlock: "#111827",
    chartColors: ["#eab308","#60a5fa","#34d399"],
    tableColors: {
      headerBg: "#1f2937",
      rowBg: "#0a0901",
