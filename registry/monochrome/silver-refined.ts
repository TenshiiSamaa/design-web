...
export const silver_refined: Palette = {
  id: "silver-refined",
  slug: "silver-refined",
  name: "Silver Refined",
  category: "monochrome",
  description: "Premium Silver Refined palette for modern interface layouts.",
  ...
  light: {
    ...
    scrollbar: "#e5e7eb",
    codeBlock: "#f3f4f6",
    chartColors: ["#9ca3af","#3b82f6","#10b981"],
    tableColors: {
      headerBg: "#f3f4f6",
      rowBg: "#ffffff",
  ...
  dark: {
    ...
    scrollbar: "#1f2937",
    codeBlock: "#111827",
    chartColors: ["#9ca3af","#60a5fa","#34d399"],
    tableColors: {
      headerBg: "#1f2937",
      rowBg: "#1f2937",
