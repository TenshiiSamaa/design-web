...
export const obsidian_dark_mono: Palette = {
  id: "obsidian-dark-mono",
  slug: "obsidian-dark-mono",
  name: "Obsidian Dark Mono",
  category: "monochrome",
  description: "Premium Obsidian Dark Mono palette for modern interface layouts.",
  ...
  light: {
    ...
    scrollbar: "#e5e7eb",
    codeBlock: "#f3f4f6",
    chartColors: ["#ffffff","#3b82f6","#10b981"],
    tableColors: {
      headerBg: "#f3f4f6",
      rowBg: "#ffffff",
  ...
  dark: {
    ...
    scrollbar: "#1f2937",
    codeBlock: "#111827",
    chartColors: ["#ffffff","#60a5fa","#34d399"],
    tableColors: {
      headerBg: "#1f2937",
      rowBg: "#030712",
