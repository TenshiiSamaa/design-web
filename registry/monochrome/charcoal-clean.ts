...
export const charcoal_clean: Palette = {
  id: "charcoal-clean",
  slug: "charcoal-clean",
  name: "Charcoal Clean",
  category: "monochrome",
  description: "Premium Charcoal Clean palette for modern interface layouts.",
  ...
  light: {
    ...
    scrollbar: "#e5e7eb",
    codeBlock: "#f3f4f6",
    chartColors: ["#1f2937","#3b82f6","#10b981"],
    tableColors: {
      headerBg: "#f3f4f6",
      rowBg: "#ffffff",
  ...
  dark: {
    ...
    scrollbar: "#1f2937",
    codeBlock: "#111827",
    chartColors: ["#1f2937","#60a5fa","#34d399"],
    tableColors: {
      headerBg: "#1f2937",
      rowBg: "#111827",
