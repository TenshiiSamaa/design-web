...
export const moss_olive: Palette = {
  id: "moss-olive",
  slug: "moss-olive",
  name: "Moss Olive",
  category: "green",
  description: "Premium Moss Olive palette for modern interface layouts.",
  ...
  light: {
    ...
    secondary: "#f3f4f6",
    secondaryForeground: "#65a30d",
    accent: "rgba(0, 0, 0, 0.05)",
    accentForeground: "#65a30d",
    muted: "#f3f4f6",
    ...
    scrollbar: "#e5e7eb",
    codeBlock: "#f3f4f6",
    chartColors: ["#65a30d","#3b82f6","#10b981"],
    tableColors: {
      headerBg: "#f3f4f6",
      rowBg: "#ffffff",
  ...
  dark: {
    ...
    scrollbar: "#1f2937",
    codeBlock: "#111827",
    chartColors: ["#65a30d","#60a5fa","#34d399"],
    tableColors: {
      headerBg: "#1f2937",
      rowBg: "#1a2e05",
