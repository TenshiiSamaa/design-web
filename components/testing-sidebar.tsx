...
export function TestingSidebar() {
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full bg-[var(--surface)] text-[var(--foreground)] border-r border-[var(--border)] overflow-hidden">
      ...
      <div className="px-4 py-4 border-b border-[var(--border)] bg-[var(--background)] flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Avatar 
            ...
            fallback="MS" 
            className="h-8 w-8 border border-[var(--primary)]/20 shrink-0"
          />
      ...
      <div className="px-4 py-2 border-t border-[var(--border)] flex items-center gap-2 justify-between bg-[var(--background)]">
        <a
          href="https://github.com/TenshiiSamaa"
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-lg border border-[var(--border)] bg-[var(--surface)] hover:bg-[var(--muted)] text-[10px] font-semibold text-[var(--foreground)] transition-colors cursor-pointer select-none"
        >
          <svg className="h-3.5 w-3.5 fill-current text-[var(--foreground)]" viewBox="0 0 24 24">
        ...
        <a
          href="https://design-web.vercel.app"
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-lg border border-[var(--border)] bg-[var(--surface)] hover:bg-[var(--muted)] text-[10px] font-semibold text-[var(--foreground)] transition-colors cursor-pointer select-none"
        >
          <svg className="h-3 w-3 fill-current text-[var(--foreground)]" viewBox="0 0 24 24">
