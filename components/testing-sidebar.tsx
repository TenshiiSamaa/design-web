    ...
    <div className="flex flex-col h-full bg-[var(--surface)] text-[var(--foreground)] border-r border-[var(--border)] overflow-hidden">
      ...
      <div className="px-4 py-2 border-t border-[var(--border)] bg-[var(--background)]">
        <a
          ...
          className="w-full flex items-center justify-center gap-2 py-1.5 rounded-lg border border-[var(--border)] bg-[var(--surface)] hover:bg-[var(--muted)] text-[10px] font-semibold text-[var(--foreground)] transition-colors cursor-pointer select-none"
        >
          <Image
            src="https://raw.githubusercontent.com/TenshiiSamaa/My-Media/refs/heads/main/media/bot/pp%20mahiru%20shiina.jpg"
            alt="design web"
